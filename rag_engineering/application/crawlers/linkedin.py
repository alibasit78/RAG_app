...
from rag_engineering.application.utils.utils import dump_text_file
from rag_engineering.domain.artifact_entity import DataIngestionArtifact
from rag_engineering.domain.config_entity import LinkedinDataIngestionConfig
from rag_engineering.domain.exceptions import ImproperlyConfigured
from rag_engineering.settings import settings

from .base import BaseSeleniumCrawler


class LinkedinCrawler(BaseSeleniumCrawler):
    data_ingestion_config = LinkedinDataIngestionConfig()
    ...
    def extract(self, link: str, **kwargs) -> None:
        ...
        #     ]
        # )
        ln_post_fpath = os.path.join(self.data_ingestion_config.linkedin_post_dir, self.data_ingestion_config.linkedin_post_file)
        os.makedirs(ln_post_fpath, exist_ok=True)
        dump_text_file(ln_post_fpath, posts)
